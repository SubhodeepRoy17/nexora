...
- The public AI-shopper guide uses Nexora's established watercolor bento cards, compact developer-console surfaces, bounded execution timeline, and responsive CTA system to translate the machine contract for people. Raw capability, OpenAPI, catalog, and policy documents remain separate, explicitly labelled developer resources rather than navbar destinations.
...
- `/ai-shoppers` — responsive human-readable guide to the external AI-buyer contract and its machine resources.
