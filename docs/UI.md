...
- Desktop users get a restrained, slightly larger Windows-style arrow with a subtle Nexora violet edge. Familiar native cursor shapes remain intact for links, controls, text editing, dragging, resizing, and disabled states, while touch interaction is unchanged.
