      ...
      <section className="overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 shadow-xl shadow-slate-950/20">
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[900px] border-collapse text-left">
            <thead><tr className="inventory-table-head border-b border-slate-800 bg-slate-900 font-mono text-[8px] uppercase tracking-wider text-slate-100"><th className="px-5 py-3.5 font-semibold">Product</th><th className="px-4 py-3.5 font-semibold">Price</th><th className="px-4 py-3.5 font-semibold">Stock</th><th className="px-4 py-3.5 font-semibold">Agent visible</th><th className="px-4 py-3.5 font-semibold">Performance</th><th className="px-4 py-3.5 font-semibold">Structured specs</th><th className="px-4 py-3.5" /></tr></thead>
