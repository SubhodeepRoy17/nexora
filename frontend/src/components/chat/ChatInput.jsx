...
export default function ChatInput({ value, onChange, onSubmit, presets, disabled = false }) {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <form onSubmit={submit} className="buyer-input flex items-center gap-2 rounded-xl border border-emerald-950/10 bg-white/88 p-2.5 shadow-[0_18px_48px_rgba(42,81,68,.14)] backdrop-blur-xl transition focus-within:border-slate-400 focus-within:shadow-[0_20px_55px_rgba(42,81,68,.16)]">
        ...
        <input
          ...
          className="min-h-11 min-w-0 flex-1 bg-transparent px-1 text-sm text-[#17372f] outline-none placeholder:text-[#31594f]/45 focus:outline-none focus-visible:outline-none disabled:cursor-wait"
